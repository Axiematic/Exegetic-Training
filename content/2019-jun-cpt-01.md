...
In this course you’ll become familiar with your new best friend: the tidyverse. You'll learn how to load data from CSV and XLSX files then how to wrangle those data into submission.

Three R packages (dplyr, tidyr and purrr) expose an wide range of functionality to aid in the data preparation process.
...
*Prices include lunch and refreshments during the coffee breaks for both days.
  ...
  <table width: 100% style="margin-bottom: 1%;">
      <tr>
          <th class="pricing">Early-Bird (available until 23 August 2019)</th>
      </tr>
      <tr>
          <td class="pricing">R 3000 Per ticket</td>
      </tr>
      <tr>
          <th class="pricing">Standard (available until 27 August 2019)</th>
      </tr>
      <tr>
